...
const CourseRoadmap = ({ courseData, isOpen, onClose, currentModuleIndex, currentLessonIndex, isFullPage = false }) => {
  ...
  const roadmapContent = (
    <div className={isFullPage ? "roadmap-full-page" : "roadmap-modal"}>
